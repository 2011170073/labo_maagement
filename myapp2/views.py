...
class teacher_list_view(View):
    def get(self,req):
        data = {"teacher_list":models.teacher.objects.all()}
...
class status_list_view(View):
    def get(self,req,pk):
        ...
        data = {"status_list_pk":teacher_pk.status_list_set.all()}
...
class status_list_last_view(View):
    def get(self,req,pk):
        status_list_last = models.status_list.objects.get(pk=pk)
        data = {"status_list_pk_detail":status_list_last}
        return render(req,"status_list_last.html",data)
